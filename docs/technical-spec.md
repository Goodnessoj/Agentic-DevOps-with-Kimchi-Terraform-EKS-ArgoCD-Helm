...
|-----------------|---------|-------------------|
| `petclinic-{env}/config-server` | Config Server | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/config-server:{tag}` |
| `petclinic-{env}/discovery-server` | Discovery Server | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/discovery-server:{tag}` |
| `petclinic-{env}/api-gateway` | API Gateway | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/api-gateway:{tag}` |
| `petclinic-{env}/customers-service` | Customers Service | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/customers-service:{tag}` |
| `petclinic-{env}/visits-service` | Visits Service | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/visits-service:{tag}` |
| `petclinic-{env}/vets-service` | Vets Service | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/vets-service:{tag}` |
| `petclinic-{env}/genai-service` | GenAI Service | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/genai-service:{tag}` |
| `petclinic-{env}/admin-server` | Admin Server | `{account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/admin-server:{tag}` |
...
# Push
docker push {account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/{service}:{tag}
```
...
|-------------------|--------------------|-----------|------------|---------|
| `petclinic-{env}-eso-role` | `external-secrets-sa` | `external-secrets` | `secretsmanager:GetSecretValue`, `secretsmanager:DescribeSecret` on `arn:aws:secretsmanager:us-east-2:{account}:secret:petclinic/*` | ESO |
...
replicaCount: 1
image:
  repository: ""   # Set per-service: {account}.dkr.ecr.us-east-2.amazonaws.com/petclinic-{env}/{service}
